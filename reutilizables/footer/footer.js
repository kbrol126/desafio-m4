function importFooterComponent() {
  ...
  component.innerHTML = `<section class="footer">
    ...
    <div class="footer__redes">
        ...
        <img src defer="./reutilizables/footer/Instagram.png" class="footer__img"></a>
   
        <a class="footer__links" href="https://www.linkedin.com/in/nahuel-cabral-0b20354a"> Linkedin
        <img src defer="./reutilizables/footer/Linkedin.png" class="footer__img"></a>
       
        <a class="footer__links" href="https://github.com/kbrol126"> GitHub
        <img src defer ="./reutilizables/footer/GitHub.png" class= "footer__img"></a>
  </div>
  </section>`;
  return component;
}
